...
function addGiftItem(data) {
	...
	<div class="row g-2">
		...
		<div class="col-11">
			...
			<div class="row g-1">
				<div class="col-2">
					<img class="w-75 h-auto rounded-circle" src="${data.giftPictureUrl}">
				</div>
				<div class="col-10">
				...
				if(i < 2){
					top += `<li class="nav-item">
						<a class="nav-link" aria-current="page" href="https://tiktok.com/@${viewers[i].user.uniqueId}" target="_blank">
							<img style="width:30px; max-width:30px;" class="h-auto rounded-circle" src="${viewers[i].user.profilePictureUrl}">
